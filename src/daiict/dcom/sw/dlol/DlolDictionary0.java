...
public class DlolDictionary0 extends LinkedHashMap<String, String> {
		/**
	 * 
	 */
	...
	public String getSubject(){
		...
		if(index < 0)
			return "";
		else if ((index == getIndexOf("JJ") )|| (index == getIndexOf("DT")) )
			return "";
		else
	...
	*/
	...
	{  
		...
		if(index==0){
			...
			//System.out.println(valueom);
			while(!valueom.equals("NN")&&!valueom.equals("NNP"))
			{   //System.out.println(index);
